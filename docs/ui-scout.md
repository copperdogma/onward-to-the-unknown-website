...
|---|---|---|---|
| WB1 — Whole-Book Reading Surface | Build the accepted bundle through the current whole-book shell, then walk the key reading paths on desktop and mobile until the site feels honest, legible, and ready to ship for older family readers | 2026-04-10 | Initial run found landing-page scan fatigue and generic page/image labels. The Story 006 rerun cleared those blocking findings for the current shell. |
